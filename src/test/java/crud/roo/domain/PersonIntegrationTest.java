...
public class PersonIntegrationTest {
    ...
    public void testFindAllPeople() throws InstantiationException, IllegalAccessException {
        ...
        List<? extends GenericEntity> result = Person.findAll(Person.class);
    ...
    public void testFindPersonEntries() throws InstantiationException, IllegalAccessException {
        ...
        List<? extends GenericEntity> result = Person.findEntries(firstResult, maxResults, Person.class);
    ...
    public void testRemove() throws InstantiationException, IllegalAccessException {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", Person.find(id, Person.class));
    }
}
